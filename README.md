...
1. In Jest, what are the differences between `describe()` and `it()` globals, and what are good uses for them?
  ...
  A - `describe()` is a way to encompass a suite of tests meanwhile `it()` is used to show what a specific test will test.

1. What is the point of `Test Driven Development`? What do you think about this approach?

  A- TDD is important because it for one makes sure we write clean code. It also makes sure that when we refactor our code, nothing breaks. It is a safety net. I personally really like TDD and I plan on using it in my professional career.

1. Mention three types of automated tests.

  A - Unit Testing, Integration Testing, Snapshot testing
